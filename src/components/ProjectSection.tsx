        ...
        <div className="relative min-h-screen bg-black text-orange-50 font-mono py-20 overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-6 max-w-7xl">
                ...
                <div className="text-center mt-20">
                    <a href="https://github.com/shreeharshshinde" target="_blank" rel="noopener noreferrer" className="inline-block px-8 py-4 border border-white/10 hover:border-orange-500/50 text-gray-400 hover:text-orange-400 transition-all tracking-[0.2em] text-sm uppercase group">
