    ...
    return (
        <footer className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute -bottom-40 -right-40 w-80 h-80 bg-purple-500 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-pulse" style={{ animationDelay: '2s' }}></div>
            </div>
            ...
            <div className="relative z-10 container mx-auto px-6 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-gray-400 leading-relaxed">
                            A passionate computer science student and software developer focused on creating innovative solutions and building the future of technology.
                        </p>
                    </div>
                    ...
                    <div className="text-center md:text-right">
                        ...
                        <div className="flex flex-wrap justify-center md:justify-end gap-2">
                            <span className="px-3 py-1 text-xs bg-cyan-500/20 text-cyan-400 rounded-full border border-cyan-500/30">React</span>
                            <span className="px-3 py-1 text-xs bg-blue-500/20 text-blue-400 rounded-full border border-blue-500/30">TypeScript</span>
                            <span className="px-3 py-1 text-xs bg-purple-500/20 text-purple-400 rounded-full border border-purple-500/30">Three.js</span>
                            <span className="px-3 py-1 text-xs bg-emerald-500/20 text-emerald-400 rounded-full border border-emerald-500/30">Tailwind CSS</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="text-center mt-8 pt-8 border-t border-gray-700/50">
                    <p className="text-gray-500 text-sm">
                        Made with <span className="text-red-400">❤️</span> and lots of <span className="text-cyan-400">☕</span>
                    </p>
                </div>
            </div>
            ...
            <div className="absolute bottom-10 left-10 w-3 h-3 bg-purple-400 rounded-full animate-pulse"></div>
    </footer>
);
};